...
app.config.file('global', { type: 'file', file: path.join(__dirname, 'config', 'config.json') });
app.config.file('user', { type: 'file', file: path.join('/home', process.env.USER, '.wirt.json') });
